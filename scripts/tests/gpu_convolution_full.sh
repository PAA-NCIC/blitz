...
do
if ./samples/gpu/convolution/convolution ${PHASE[$i]} ${ALG[$j]} ${INPUT_LAYOUT[$k]} ${OUTPUT_LAYOUT[$v]} ${BATCH_SIZE} 3 224 224 3 3 64 224 224 1 1 1 1 ${ITERS}
then
...
if ./samples/gpu/convolution/convolution ${PHASE[$i]} ${ALG[$j]} ${INPUT_LAYOUT[$k]} ${OUTPUT_LAYOUT[$v]} ${BATCH_SIZE} 64 112 112 3 3 128 112 112 1 1 1 1 ${ITERS}
then
...
if ./samples/gpu/convolution/convolution ${PHASE[$i]} ${ALG[$j]} ${INPUT_LAYOUT[$k]} ${OUTPUT_LAYOUT[$v]} ${BATCH_SIZE} 128 56 56 3 3 256 56 56 1 1 1 1 ${ITERS} 
then
...
if ./samples/gpu/convolution/convolution ${PHASE[$i]} ${ALG[$j]} ${INPUT_LAYOUT[$k]} ${OUTPUT_LAYOUT[$v]} ${BATCH_SIZE} 256 56 56 3 3 256 56 56 1 1 1 1 ${ITERS}
then
...
if ./samples/gpu/convolution/convolution ${PHASE[$i]} ${ALG[$j]} ${INPUT_LAYOUT[$k]} ${OUTPUT_LAYOUT[$v]} ${BATCH_SIZE} 256 28 28 3 3 512 28 28 1 1 1 1 ${ITERS}
then
...
if ./samples/gpu/convolution/convolution ${PHASE[$i]} ${ALG[$j]} ${INPUT_LAYOUT[$k]} ${OUTPUT_LAYOUT[$v]} ${BATCH_SIZE} 512 28 28 3 3 512 28 28 1 1 1 1 ${ITERS}
then
...
if ./samples/gpu/convolution/convolution ${PHASE[$i]} ${ALG[$j]} ${INPUT_LAYOUT[$k]} ${OUTPUT_LAYOUT[$v]} ${BATCH_SIZE} 512 14 14 3 3 512 14 14 1 1 1 1 ${ITERS}
then
...
for((v=0;v<${#OUTPUT_LAYOUT[@]};v++))
do
if ./samples/gpu/convolution/convolution ${PHASE[$i]} ${ALG[$j]} ${INPUT_LAYOUT[$k]} ${OUTPUT_LAYOUT[$v]} ${BATCH_SIZE} 3 231 231 11 11 96 56 56 0 0 4 4 ${ITERS}
then
...
if ./samples/gpu/convolution/convolution ${PHASE[$i]} ${ALG[$j]} ${INPUT_LAYOUT[$k]} ${OUTPUT_LAYOUT[$v]} ${BATCH_SIZE} 96 28 28 5 5 256 24 24 0 0 1 1 ${ITERS}
then
...
if ./samples/gpu/convolution/convolution ${PHASE[$i]} ${ALG[$j]} ${INPUT_LAYOUT[$k]} ${OUTPUT_LAYOUT[$v]} ${BATCH_SIZE} 256 12 12 3 3 512 12 12 1 1 1 1 ${ITERS} 
then
...
if ./samples/gpu/convolution/convolution ${PHASE[$i]} ${ALG[$j]} ${INPUT_LAYOUT[$k]} ${OUTPUT_LAYOUT[$v]} ${BATCH_SIZE} 512 12 12 3 3 1024 12 12 1 1 1 1 ${ITERS}
then
...
if ./samples/gpu/convolution/convolution ${PHASE[$i]} ${ALG[$j]} ${INPUT_LAYOUT[$k]} ${OUTPUT_LAYOUT[$v]} ${BATCH_SIZE} 1024 12 12 3 3 1024 12 12 1 1 1 1 ${ITERS}
then
