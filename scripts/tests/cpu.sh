...
then
	echo "Alexnet third layer pass!"
else
	echo "Alexnet third layer fail!"
	exit 1
fi
...
then
	echo "Alexnet fourth layer pass!"
else
	echo "Alexnet fourth layer fail!"
	exit 1
fi
