...
inline void Backend<CPUTensor, DType>::MaxPooling2DForwardFunc(
  ...
  // no padding
  #pragma omp parallel for collapse(2) private(batch_input_offset, \
    batch_output_offset, channel_input_offset, channel_output_offset)
...
template<typename DType>
inline void Backend<CPUTensor, DType>::MaxPooling2DBackwardFunc(
